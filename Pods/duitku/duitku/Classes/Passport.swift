...
public class Passport  {
    ...
    func runPassport(context : CheckoutDuitku, url : String , webView : WKWebView , reference : String , imageLoading : UIImageView , cardLoading : UIView ,checkoutDuitku :UIViewController )   {
