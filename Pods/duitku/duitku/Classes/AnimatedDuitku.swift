...
//  MakeSDK
//
//  Created by Bambang Maulana on 09/04/20.
...
extension UIImageView {
    ...
    @available(iOS 9.0, *)
    public func loadGifDuitku(asset: String , myclass: AnyClass) {
        DispatchQueue.global().async {
            let image = UIImage.gifDuitku(asset: asset , myclass: myclass)
...
extension UIImage {
    ...
    public class func gifDuitku(data: Data) -> UIImage? {
    ...
    @available(iOS 9.0, *)
    public class func gifDuitku(asset: String , myclass: AnyClass) -> UIImage? {
        ...
        if let url = podBundle.url(forResource: "Animated", withExtension: "bundle") { //<YourBundleName> must be the same as you wrote in .podspec
               ...
               if let path = bundle!.path(forResource: fileName, ofType: fileType) {
                 ...
                 return UIImage.gifDuitku(data: data! as Data)
               }
         }
